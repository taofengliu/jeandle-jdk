...
enum FlagCounter_JEANDLE   { JEANDLE_PRESENT(JEANDLE_FLAGS(ENUM_F, ENUM_F, ENUM_F, ENUM_F, ENUM_F, IGNORE_F, IGNORE_F)) num_flags_JEANDLE };
...
const int first_flag_enum_JEANDLE    = first_flag_enum_C2       + num_flags_C2;
const int first_flag_enum_other      = first_flag_enum_JEANDLE  + num_flags_JEANDLE;
...
static constexpr int flag_group(int flag_enum) {
  ...
  if (flag_enum < first_flag_enum_JEANDLE)  return JVMFlag::KIND_C2;
  if (flag_enum < first_flag_enum_other)    return JVMFlag::KIND_JEANDLE;
